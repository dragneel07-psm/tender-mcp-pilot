...
**Status: Milestones 1, 2, and 3 shipped.** See `CHANGELOG.md` for what actually landed in each (the entries there are the record of truth; this file stays the forward-looking plan and isn't rewritten after the fact).
