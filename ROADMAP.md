...
**Status: Milestones 1-6 shipped.** See `CHANGELOG.md` for what actually landed in each (the entries there are the record of truth; this file stays the forward-looking plan and isn't rewritten after the fact).
